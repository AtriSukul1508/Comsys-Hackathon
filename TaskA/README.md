...
> 2. The pre-trained model weights can be accessed and downloaded from [*best_model.pth (size: 188.5MB)*](https://drive.google.com/file/d/1mB9Lqozewq4QgigvqeLhURdgIKyrKcZD/view?usp=sharing). <br/>
